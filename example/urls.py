...
urlpatterns = patterns('',
    url(r'^contact/$', StatementView.as_view(),
        name='contact_list'),
    url(r'^contact/add/$', ContactWizard.as_view(formslist),
        name='contact_add'),
    url(r'^contact/edit/(?P<statement_id>[-\d]+)$', 'example.views.edit_wizard',
        name='contact_edit'),
    url(r'^contact/submit/$', views.submit_wizard, name='submit_confirm'),
    #url(r'^contact/quit/$', views.quit_wizard, name='quit_wizard'),
)
